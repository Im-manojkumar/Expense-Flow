                ...
                <PieChart>
                  ...
                  >
                    {data.categoryData.map((entry, index) => {
                      const COLORS = ['#primary', '#f97316', '#10b981', '#3b82f6', '#8b5cf6'];
                      return <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length] === '#primary' ? 'rgb(var(--color-primary))' : COLORS[index % COLORS.length]} />;
                    })}
                  </Pie>
